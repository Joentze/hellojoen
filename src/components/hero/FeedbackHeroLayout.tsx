...
const FeedbackHeroLayout: React.FC<IHeroLayout> = ({ isSend, engageBtnFn, connectBtnFn, SetFirstName, SetLastName, SetEmail, SetFeedback }): React.ReactElement => {
      ...
      <div className='w-full flex h-96 md:h-screen p-8 overflow-y-scroll scrollbar-style-none pb-40'>
        {isSend
          ? <div className='m-auto text-center flex flex-col'>
            <p className='text-lg text-slate-600'>Meanwhile, check out my projects <a href='/projects'><u className='decoration-4 hover:decoration-2 ease-in-out duration-200'>here</u></a></p>
          </div>
